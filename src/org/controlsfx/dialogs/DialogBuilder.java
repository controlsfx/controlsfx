...
public final class DialogBuilder<T> {
	...
	public DialogBuilder<T> openDetailsInNewWindow(
	        final boolean openDetailsInNewWindow) {
	...
	public DialogBuilder<T> inputChoices(
	...
	private DialogTemplate<T> getDialogTemplate(final DialogType dlgType) {
		...
		String actualMasthead = masthead == null ? dlgType.getDefaultMasthead()
		        : masthead;
		DialogOptions actualOptions = options == null ? dlgType
